...
class CustomAdapter(private val mList: List<Placar>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        val tvTime1: TextView = ItemView.findViewById(R.id.tvT1F)
        val tvTime2: TextView = ItemView.findViewById(R.id.tvT2F)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        ///
        holder.tvTime1.text = placarAnterior.tvTime1

        val nometvAbreviado1 = if ( holder.tvTime1.text.length >= 3)  holder.tvTime1.text.substring(0, 3) else  holder.tvTime1.text
        holder.tvTime1.text = nometvAbreviado1

        holder.tvTime2.text = placarAnterior.tvTime2

        val nometvAbreviado2 = if ( holder.tvTime2.text.length >= 3)  holder.tvTime2.text.substring(0, 3) else  holder.tvTime2.text
        holder.tvTime2.text = nometvAbreviado2
